                    ...
                    <div class="auth-form card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="POST" action="{{ route('password.confirm') }}">
                                ...
                                <input id="security_answer" type="text" placeholder="Your answer" class="form-control @error('security_answer') is-invalid @enderror" name="security_answer" value="{{ old('security_answer') }}" required>
                                ...
                                <div class="text-center">
                                    <button type="submit" class="btn btn-primary btn-block"> {{ __('Submit Answer') }}</button>
                                </div>
