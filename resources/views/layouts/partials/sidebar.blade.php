<div class="sidebar">
    <a class="brand-logo" href="{{auth()->user()->is_admin?route('clients.index'):route('trade-statement')}}">
        <img class="w-100" src="{{asset('images/logo.svg')}}" alt="">
    </a>
    <div class="menu">
        <ul>
            @if (Auth::user()->is_admin)
                ...
                <li class="{{request()->is('trades*')?'mobile-active':''}}"><a href="{{route('trades.index')}}"   class="{{request()->is('trades*')?'active':''}}">
                        <span><i class="mdi mdi-repeat"></i></span>
                        <span class="nav-text">Trades</span>
                    </a>
                </li>
                <li class="{{request()->is('events*')?'mobile-active':''}}"><a  href="{{route('events.index')}}" class="{{request()->is('events*')?'active':''}}">
                        <span><i class="mdi mdi-trophy-outline"></i></span>
                        <span class="nav-text">Events</span>
                    </a>
                </li>
                <li class="{{request()->is('teams*')?'mobile-active':''}}"><a href="{{route('teams.index')}}"  class="{{request()->is('teams*')?'active':''}}">
            ...
            @else
                <li class="{{request()->is('trade-statement*')?'mobile-active':''}}">
                    <a href="{{route('trade-statement')}}" class="{{request()->is('trade-statement*')?'active':''}}">
                ...
                <li class="{{request()->is('motorsport-markets')?'mobile-active':''}}">
                    <a href="{{route('motorsport-markets')}}" class="{{request()->is('motorsport-markets')?'active':''}}">
                ...
                <li class="{{request()->is('add-funds')?'mobile-active':''}}"><a href="{{route('add-funds')}}"  class="{{request()->is('add-funds')?'active':''}}">
                        <span><i class="mdi mdi-plus-circle"></i></span>
                        <span class="nav-text">Add Funds</span>
                    </a>
                </li>
                <li class="{{request()->is('withdraw-funds')?'mobile-active':''}}"><a  href="{{route('withdraw-funds')}}" class="{{request()->is('withdraw-funds')?'active':''}}">
                        <span><i class="mdi mdi-minus-circle"></i></span>
                        <span class="nav-text">Withdraw Funds</span>
                    </a>
                </li>
                <li class="{{request()->is('help')?'mobile-active':''}}"><a href="{{route('help')}}"  class="{{request()->is('help')?'active':''}}">
